<?php
$con = @mysqli_connect('localhost','root', '','colourprediction_new');
//$con = @mysqli_connect('localhost','evoliveonline_colourprediction', '^$=#SUS{AS?n','evoliveonline_colourprediction');
...
$cons = @mysqli_connect('localhost','root', '','evolive');
// $con = @mysqli_connect('localhost', 'root', '', 'colourprediction_lootlemoney');
