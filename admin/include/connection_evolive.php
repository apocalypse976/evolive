<?php
$cons = @mysqli_connect('localhost','starksoftwares_evolive', 'Gl%fRQOV4@_*','starksoftwares_evolive');
// $con = @mysqli_connect('localhost', 'root', '', 'colourprediction_lootlemoney');
...
function winner($cons,$periodid,$tab,$column)
{
$query=mysqli_query($cons,"SELECT 
...
$sqlbonus=mysqli_query($cons,"select `bonusamount` from `tbl_paymentsetting` where `id`='1'");
