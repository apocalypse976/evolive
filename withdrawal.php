...
<h4 class="text-center m-2">Balance: <span>₹ <?php echo number_format(wallet($con,'amount',$userid), 2);?></span></h4>
    ...
    <form action="#" id="paymentForm" method="post" class="card-body" autocomplete="off"><h6 class="text-center m-2" Style="font-size:11px; color: red;">Minimmum Withdrawal is Now 250 Rs</h6>
